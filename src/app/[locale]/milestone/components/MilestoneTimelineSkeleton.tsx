      ...
      <div className="min-h-screen py-12 px-4 pt-24 max-w-3xl mx-auto text-gray-300">
        {Array.from({ length: 3 }).map((_, idx) => (
          <section key={idx} className="relative mb-16 animate-pulse">
            ...
            {/* 标题骨架 */}
            <div className="ml-12 h-8 w-3/5 bg-blue-400 rounded mb-2"></div>
            {/* 描述骨架 */}
            <div className="ml-12 h-5 w-4/5 bg-blue-300 rounded mb-4"></div>
            {/* 卡片骨架 */}
            <div
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center gap-6 p-4">
                {/* 封面骨架 */}
                <div className="md:w-1/2 w-full h-40 rounded-xl bg-blue-400/40"></div>
                {/* 信息骨架 */}
                <div className="md:w-1/2 w-full flex flex-col justify-center py-4 px-2 space-y-3">
                  <div className="h-6 bg-blue-400 rounded w-3/4"></div>
                  <div className="h-4 bg-blue-300 rounded w-1/2"></div>
                  <div className="flex gap-2">
                    <div className="h-5 bg-blue-300 rounded w-12"></div>
                    <div className="h-5 bg-blue-300 rounded w-16"></div>
                    <div className="h-5 bg-blue-300 rounded w-10"></div>
                  </div>
                </div>
              </div>
            </div>
