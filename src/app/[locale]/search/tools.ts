...
export const navData: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://chemingqiang.oss-cn-shenzhen.aliyuncs.com/bag_2/photogrid.webp',
        title: 'photogrid',
        url: 'https://www.photogrid.app/zh-cn/image-enhancer/',
        desc: '图片清晰 可以白嫖 dom直接下载',
      },
      {
        icon: 'https://chemingqiang.oss-cn-shenzhen.aliyuncs.com/bag_2/picwish.png',
        title: 'pic wish',
